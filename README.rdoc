...
=== Parsing an existing workbook
  ...
  This method takes two parameters:
    data_only: boolean. If you don't care about cell formatting or formulas or any of that stuff and just
                        want to read the values, pass true. This will speed up the parsing significantly.
    read_only: boolean. If you don't care about writing the file back out, pass true. This reduces the
                        memory footprint for large files significantly.
